# Anatomy Generation Prompt Template (v0.15)

**Status:** Normative for `.anatomy` v0.15 generation.
...
This prompt template is published at `https://anatomy.dev/spec/0.15/prompt.md` and is part of the v0.15 schema contract. Any change to the prompt requires bumping `anatomy_version` to `0.16` (additive) or `1.0` (breaking).
