# Anatomy Generation Prompt Template (v0.5)

**Status:** Normative for `.anatomy` v0.5 generation.
...
This prompt template is published at `https://anatomy.dev/spec/0.5/prompt.md` and is part of the v0.5 schema contract. Any change to the prompt requires bumping `anatomy_version` to `0.6` (additive) or `1.0` (breaking).
