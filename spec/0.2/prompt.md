# Anatomy Generation Prompt Template (v0.2)

**Status:** Normative for `.anatomy` v0.2 generation.
...
This prompt template is published at `https://anatomy.dev/spec/0.2/prompt.md` and is part of the v0.2 schema contract. Any change to the prompt requires bumping `anatomy_version` to `0.3` (additive) or `1.0` (breaking).
