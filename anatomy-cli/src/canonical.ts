...
//   - anatomy-validate/src/canonical.ts (the validator's copy)
// fingerprintFromPillars was added here first and mirrored to the other two; the
// canonicalize/hash/canonicalHash trio has not changed since v0.1.
